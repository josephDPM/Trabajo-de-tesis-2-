...
\fancypagestyle{special}{%
	\fancyhead[L]{\changefont Diseño de un modelo de Machine Learning y aplicativo móvil para predecir la demanda en una empresa distribuidora YAELSA EIRL}
	\fancyhead[R]{\thepage}}
...
\begin{titlepage}
	...
	\begin{center}
		...
		\vspace*{8ex} \\
		%\textbf
		{Diseño de un modelo de Machine Learning y aplicativo móvil para predecir la demanda en una empresa distribuidora YAELSA EIRL}
		\vspace*{8ex}\\	
		Tesis de investigación para el curso Trabajo de Tesis II 
		\vspace*{8ex} \\	
		Joseph Daniel Perez Matos \\
